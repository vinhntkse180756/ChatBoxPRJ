...
public sealed class BenchmarkRepository(AppDbContext db) : IBenchmarkRepository
{
...
public sealed class StudentTokenUsageRepository(AppDbContext db) : IStudentTokenUsageRepository
{
...
public sealed class EfVectorStore(AppDbContext db) : IVectorStore
{
