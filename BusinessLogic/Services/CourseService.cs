...
using BusinessAccessLevel = BusinessLogic.DTOs.LecturerAccessLevel;
using BusinessUserRole = BusinessLogic.DTOs.UserRole;
using DataAccessLevel = BusinessObjects.Entities.LecturerAccessLevel;
using DataUserRole = BusinessObjects.Entities.UserRole;

namespace BusinessLogic.Services;

public sealed class CourseService(ICourseRepository courses, IUserRepository users, IMapper mapper) : ICourseService
{
