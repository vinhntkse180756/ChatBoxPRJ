...
public sealed class LearningDocument
{
    ...
    [MaxLength(50)] public string ChunkingStrategy { get; set; } = "WordCount";
    [MaxLength(100)] public string EmbeddingModel { get; set; } = "gemini-embedding-001";
...
public sealed class BenchmarkRun
{
    ...
    [MaxLength(200)] public string ModelName { get; set; } = "";
...
/// <summary>Kết quả 1 câu trong test set — lưu các metric bao gồm cả streaming.</summary>
public sealed class BenchmarkResult
{
    ...
    [MaxLength(100)] public string ModelName { get; set; } = "";
